    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('client', 'Client'), ('proprietaire', 'Propriétaire'), ('admin', 'Administrateur')], default='client', max_length=20, verbose_name='type utilisateur')),
